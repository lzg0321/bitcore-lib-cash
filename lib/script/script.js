...
Script.prototype.isScriptHashIn = function() {
  ...
  if (redeemScript && redeemScript.chunks.length > 0) {
    return true;
  }
  return false;
...
Script.prototype.isDataOut = function() {
  if (this.chunks[0].opcodenum === Opcode.OP_FALSE && this.chunks[1].opcodenum === Opcode.OP_RETURN) {
    var bsvChunks = this.chunks.slice(2);
    var bsvScript2 = new Script({chunks: bsvChunks});
    return bsvScript2.isPushOnly();
  }
